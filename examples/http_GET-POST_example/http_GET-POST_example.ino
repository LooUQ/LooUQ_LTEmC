/** ***************************************************************************
  @file http_GET-POST_example.ino
  @brief LTEm example for HTTP(S) client (GET/POST) communications.
...
#define LOG_LEVEL LOGLEVEL_DBG              // Enable full logging

/* specify the pin configuration 
 * --------------------------------------------------------------------------------------------- */
#ifdef ARDUINO_ARCH_ESP32
    #define HOST_ESP32_DEVMOD_DEVC
#else
