 ...
 *  @param [in] eventNotifCB Callback function in application code to be invoked when LTEmC is in await section.
 */
 ...
 */
resultCode_t ltem_setRfPriority(ltemRfPriorityMode_t radioPriority);
