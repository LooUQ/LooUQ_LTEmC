 ...
 */
void atcmd_configDataMode(uint16_t contextKey, const char* trigger, dataHndlr_func rxDataHndlr, char* txDataLoc, uint16_t txDataSz, appRcvProto_func applRecvDataCB, bool skipParser);
