...
/* Add one of the host board defines from the list below to configure your LTEmC connection. 
 * To extend, define your connections in a new ltemPinConfig_t initialization and give it a name.
